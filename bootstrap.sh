...
pip install Django GitPython Jinja2 MarkupSafe PyYAML ansible ansible-role-manager argparse colorama django-crispy-forms gitdb hgapi paramiko pycrypto pysphere requests semantic-version smmap wsgiref django-bootstrap3
