...
urlpatterns = [
    ...
    url(r'^credentialindex/$', views.credentialIndex.as_view(), name='credentialIndex'),
    url(r'^createcredential/$', views.createCredential.as_view(), name='createCredential'),
    url(r'^editcredential/(?P<pk>\d+)/$', views.editCredential.as_view(), name='editCredential'),
    ...
    url(r'^deletecredential/(?P<pk>\d+)/$', views.deleteCredential.as_view(), name='deleteCredential'),
